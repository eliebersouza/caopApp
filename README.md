...
To optimize the caopApp application for production, run:
...
[Doing microservices with JHipster]: http://www.jhipster.tech/documentation-archive/v4.14.2/microservices-architecture/
