...
public class FaixaEtariaResource {
    ...
    @Timed
    public ResponseEntity<FaixaEtariaDTO> createFaixaEtaria(@Valid @RequestBody FaixaEtariaDTO faixaEtariaDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<FaixaEtariaDTO> updateFaixaEtaria(@Valid @RequestBody FaixaEtariaDTO faixaEtariaDTO) throws URISyntaxException {
